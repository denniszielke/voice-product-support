"""A2A test client for the support-hotline agent on Azure AI Foundry."""
...
TEST_MESSAGES = [
    "What kind of bike support can you provide?",
    "My hydraulic disc brakes on my CityRider Pro are squealing. How do I fix this?",
    "The suspension fork on my TrailBlaster 29 is leaking oil — what should I do?",
    "My child's JuniorTrail 20 keeps dropping the chain. How do I fix it?",
]
