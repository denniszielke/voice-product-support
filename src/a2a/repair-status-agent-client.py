"""A2A test client for the repair-status agent on Azure AI Foundry."""
...
TEST_MESSAGES = [
    ...
    "What is the status of repair job REP-1002?",
    "I need to book a repair for my TrailBlaster 29 — the suspension fork is leaking oil",
    "Can you check all repairs for customer Alice Müller?",
]
